...
class SipClient {
    ...
    handleNewRTCSession(sessionEvent) {
        ...
        if (sessionEvent.originator === 'remote') {
            ...
            this.callService.analyticsService.trackEvent('sipIncomingCall', { callUUID: (_a = sessionEvent === null || sessionEvent === void 0 ? void 0 : sessionEvent.request) === null || _a === void 0 ? void 0 : _a.call_id });
            return;
        }
