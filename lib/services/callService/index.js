...
const sipSessionStore_1 = require("../sipSessionStore");
exports.HELD = 'held';
...
class CallService extends eventemitter3_1.EventEmitter {
    ...
    setSdkStrings(prompts) {
        prompts_1.default.setPrompts(prompts);
    }
    async getAudioRecordPermission() {
        return new Promise((resolve, reject) => {
            ...
            react_native_1.PermissionsAndroid.check(react_native_1.PermissionsAndroid.PERMISSIONS.RECORD_AUDIO).then((hasPermission) => {
                if (hasPermission) {
                    resolve(true);
                    return;
                }
                const prompts = prompts_1.default.getPrompts();
                react_native_1.Alert.alert(prompts.initialPermissions.title, prompts.initialPermissions.body, [
    ...
    async getSipSession() {
        ...
        if (!this.sipSession) {
            this.sipSession = await (0, sipSessionStore_1.loadSipSession)();
        }
        return this.sipSession;
    }
    async readSipSessionFromHost() {
        var _a, _b, _c, _d;
        if (!this.sdkConfig) {
            return undefined;
        }
        try {
            ...
            if (!(0, sipSessionStore_1.isUsableSipCredentials)(credentials)) {
                return undefined;
            }
            const session = {
                credentials,
                contactParams: (_c = (_b = (_a = this.sdkConfig).sipContactParams) === null || _b === void 0 ? void 0 : _b.call(_a)) !== null && _c !== void 0 ? _c : {},
                sipOptions: (_d = this.sdkConfig.sipOptions) !== null && _d !== void 0 ? _d : {},
            };
            await (0, sipSessionStore_1.saveSipSession)(session);
            return session;
        }
        catch (error) {
    ...
    emitSdkEvent(name, properties) {
        var _a, _b;
        (_b = (_a = this.sdkConfig) === null || _a === void 0 ? void 0 : _a.onSdkEvent) === null || _b === void 0 ? void 0 : _b.call(_a, { name, properties });
    }
    ...
    removeSipCredentials() {
        ...
        void (0, sipSessionStore_1.clearSipSession)();
    }
    ...
    callScreenDisplayed(callUUID, handle, name) {
        ...
        this.armPendingCallTimeout(callUUID, this.sipClient.isRegistered ? PENDING_INVITE_TIMEOUT_MS : PENDING_SIP_WAKE_TIMEOUT_MS);
        void this.sipClient.registerClient();
    }
    ...
    armPendingCallTimeout(callUUID, timeoutMs) {
        this.clearPendingCallTimeout();
    ...
    onSipCallConfirmed(session) {
        ...
        // returns on.
        (_a = this.nativePhone) === null || _a === void 0 ? void 0 : _a.setEstablishedCall((call === null || call === void 0 ? void 0 : call.callUUID) || '', 'incoming');
    ...
    onSipCallAccepted(sessionEvent) {
        ...
        (_a = this.nativePhone) === null || _a === void 0 ? void 0 : _a.setEstablishedCall((call === null || call === void 0 ? void 0 : call.callUUID) || '', 'outgoing');
    ...
    startedCall(handle, callUUID, name) {
        ...
        let extraCallData = ((_a = this.extraCallData) === null || _a === void 0 ? void 0 : _a.callUUID) === callUUID ? this.extraCallData.callData : undefined;
        let sipHandle = ((_b = this.specialHandleCall) === null || _b === void 0 ? void 0 : _b.callUUID) === callUUID ? this.specialHandleCall.handle : handle;
    ...
    endCallByUUID(callUUID) {
        ...
        if (call) {
            ...
            if ((call === null || call === void 0 ? void 0 : call.callStatus) === 'established') {
