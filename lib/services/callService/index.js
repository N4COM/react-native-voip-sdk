    ...
    async getAudioRecordPermission() {
        return new Promise((resolve, reject) => {
            ...
            react_native_1.PermissionsAndroid.check(react_native_1.PermissionsAndroid.PERMISSIONS.RECORD_AUDIO).then((hasPermission) => {
                ...
                react_native_1.Alert.alert('Permesso richiesto', `Per effettuare o ricevere chiamate tramite l'app, è necessario autorizzare i permessi richiesti in seguito.\nConcedendo l'autorizzazione potrai utilizzare tutte le funzioni di chiamata senza interruzioni.
                    `, [
